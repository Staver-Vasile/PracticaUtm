...
<body>
			...
			<div class="container">
				<div id="menu-center" class="nav-wrapper" style="padding-top: 0.1px;">
					...
					<ul class="left hide-on-med-and-down" style="width: 100%;">
						...
						<li class="active right" ><div ><a href="#modal1" class="abcd">Cont Personal</a></div></li>
	...
	<header>
		...
		<div class="container">
			...
			<table style="border:4px solid grey; margin-top: 30px; font-size: 25px; width: 600px;  margin-left: auto;
			...
			<tbody>
				...
				$contrNr = $_SESSION["contrNr"];
				$sql = "SELECT * FROM logdata WHERE login = '$contrNr' ";
				...
				echo "<td>".$row['creditSum']. "</td>";
				echo "<td>".$row['credPeriod']. "</td>";
				echo "<td>".$row['Nume']. "</td>";
				echo "</tr>";*/
			}

			//unset($_SESSION['contrNr']);
